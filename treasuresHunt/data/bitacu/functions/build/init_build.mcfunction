...
execute at @e[type=minecraft:armor_stand,name=origin] run summon minecraft:armor_stand ~-8 ~78 ~3 {NoGravity:1,Invisible:1,NoBasePlate:1,CustomName:"\"yellow\""}
...
execute at @e[type=minecraft:armor_stand,name=origin] run summon minecraft:armor_stand ~8 ~78 ~-3 {NoGravity:1,Invisible:1,NoBasePlate:1,CustomName:"\"green\""}
